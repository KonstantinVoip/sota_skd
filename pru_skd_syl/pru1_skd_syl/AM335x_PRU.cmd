...
//Фиксированные имена PAGE 0: all executable sections should be allocated on page 0
//Фиксированные имена PAGE 1: All data sections should be allocated on page 1
...
.text  : {} > P_MEM, PAGE 0    //видимо исполняемый код
}
...
//Работающий вариант минимальный пока
/*
MEMORY
{
	PAGE 0:
...
//Ещё один вариант размещения данных
/*
MEMORY
{
	PAGE 0:
