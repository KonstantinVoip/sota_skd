...
void test_main_xmodem_recieve_functions()
{
  ...
  //	st = xmodemReceive((char *)0x81000000, 16777216);   //максимальный размер 64  К/байт
	st = xmodemReceive((unsigned char *)0x81000000, 16777216);   //максимальный размер 64  К/байт
